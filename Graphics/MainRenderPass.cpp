...
void MainRenderPass::ExecutePass() DEBUG_EXCEPT
{
	...
	graphicsContext.TransitionResources(bufferManager::g_LightShadowArray, D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE, D3D12_RESOURCE_BARRIER_ALL_SUBRESOURCES); // ShadowPrePass->Z_PrePass¿¡¼­ ÇÔ.  // Subresource 0, 1, 2 MisMatch
