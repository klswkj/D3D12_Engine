...
namespace readymade
{
    custom::SamplerDescriptor SamplerLinearWrapDesc;
    custom::SamplerDescriptor SamplerAnisoWrapDesc;
    custom::SamplerDescriptor SamplerShadowDesc;
    custom::SamplerDescriptor SamplerLinearClampDesc;
    custom::SamplerDescriptor SamplerVolumeWrapDesc;
    custom::SamplerDescriptor SamplerPointClampDesc;
    custom::SamplerDescriptor SamplerPointBorderDesc;
    custom::SamplerDescriptor SamplerLinearBorderDesc;
