...
namespace Math
{
    ...
    public: 
        ...
        __forceinline explicit Matrix3(EIdentityTag) { m_mat[0] = Vector3(EXUnitVector::kXUnitVector); m_mat[1] = Vector3(EYUnitVector::kYUnitVector); m_mat[2] = Vector3(EZUnitVector::kZUnitVector); }
        __forceinline explicit Matrix3(EZeroTag) { m_mat[0] = m_mat[1] = m_mat[2] = Vector3(EZeroTag::kZero); }
