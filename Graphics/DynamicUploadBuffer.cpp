...
void* DynamicUploadBuffer::Map()
{
    ...
    ASSERT_HR(m_pResource->Map(0, nullptr, &m_CpuVirtualAddress));
...
D3D12_VERTEX_BUFFER_VIEW DynamicUploadBuffer::VertexBufferView(uint32_t NumVertices, uint32_t Stride, uint32_t Offset /*= 0*/) const
{
...
D3D12_INDEX_BUFFER_VIEW DynamicUploadBuffer::IndexBufferView(uint32_t NumIndices, bool _32bit, uint32_t Offset /*= 0*/) const
{
