...
namespace Math
{
	...
	{
	public:
		__forceinline OrthogonalTransform() : m_rotation(EIdentityTag::kIdentity), m_translation(EZeroTag::kZero) {}
		__forceinline OrthogonalTransform(Quaternion rotate) : m_rotation(rotate), m_translation(EZeroTag::kZero) {}
		__forceinline OrthogonalTransform(Vector3 translate) : m_rotation(EIdentityTag::kIdentity), m_translation(translate) {}
		__forceinline OrthogonalTransform(Quaternion rotate, Vector3 translate) : m_rotation(rotate), m_translation(translate) {}
		__forceinline OrthogonalTransform(const Matrix3& mat) : m_rotation(mat), m_translation(EZeroTag::kZero) {}
		__forceinline OrthogonalTransform(const Matrix3& mat, Vector3 translate) : m_rotation(mat), m_translation(translate) {}
		__forceinline OrthogonalTransform(EIdentityTag) : m_rotation(EIdentityTag::kIdentity), m_translation(EZeroTag::kZero) {}
		...
		__forceinline void SetRotation(Quaternion q) { m_rotation = q; } // 주로, Quaternion(Matrix3(Right, Up, -Forward))를 담는다.
		WARNING __forceinline void SetRotation(const DirectX::XMFLOAT3& rotate) { m_rotation = Quaternion(DirectX::XMQuaternionRotationRollPitchYaw(rotate.x, rotate.y, rotate.z)); }
		__forceinline void SetTranslation(Vector3& v) { m_translation = v; }
		__forceinline void SetTranslation(DirectX::XMFLOAT3& v) { m_translation.SetX(v.x); m_translation.SetY(v.y); m_translation.SetZ(v.z); }
		...
		static __forceinline OrthogonalTransform MakeXRotation(float angle) { return OrthogonalTransform(Quaternion(Vector3(EXUnitVector::kXUnitVector), angle)); }
		static __forceinline OrthogonalTransform MakeYRotation(float angle) { return OrthogonalTransform(Quaternion(Vector3(EYUnitVector::kYUnitVector), angle)); }
		static __forceinline OrthogonalTransform MakeZRotation(float angle) { return OrthogonalTransform(Quaternion(Vector3(EZUnitVector::kZUnitVector), angle)); }
	...
	public:
		...
		__forceinline AffineTransform(Vector3 translate)
			: m_basis(EIdentityTag::kIdentity), m_translation(translate) {}
		__forceinline AffineTransform(const Matrix3& mat, Vector3 translate = Vector3(EZeroTag::kZero))
			: m_basis(mat), m_translation(translate) {}
		__forceinline AffineTransform(Quaternion rot, Vector3 translate = Vector3(EZeroTag::kZero))
		...
		__forceinline AffineTransform(EIdentityTag)
			: m_basis(EIdentityTag::kIdentity), m_translation(EZeroTag::kZero) {}
