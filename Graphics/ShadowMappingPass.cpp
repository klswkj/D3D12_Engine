...
ShadowMappingPass::ShadowMappingPass(const char* pName, custom::RootSignature* pRootSignature/* = nullptr*/, GraphicsPSO* pShadowPSO/* = nullptr*/)
...
void ShadowMappingPass::Execute(custom::CommandContext& BaseContext) DEBUG_EXCEPT
{
...

	{
		...
		graphicsContext.TransitionResource(SceneColorBuffer, D3D12_RESOURCE_STATE_RENDER_TARGET);
